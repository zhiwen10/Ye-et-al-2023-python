...
from spirals_py.task.preprocessing._task_io import load_mat_table, nanmean, save_mat
...
def getMeanMapSession(data_folder, save_folder):
    ...
    for mn in TASK_MICE:
        ...
        task_outcome = out_root() / "task" / "task_outcome"
        T_all = load_mat_table(
            release_twin(task_outcome / f"{mn}_task_outcome.mat", data_folder),
            "T_all",
        )
        trial_all = load_mat_table(
            release_twin(task_outcome / f"{mn}_task_trial_ID.mat", data_folder),
            "trial_all",
        )
        ...
        for label in labels:
            ...
            count1 = 0
            for kk in tqdm(range(len(T1)), desc="getMeanMapSession"):
                ...
                if n3:
                    ...
                    for i in range(n3):
                        ...
                        hi = indx[i] + 70  # MATLAB indx+70 inclusive -> 0-based exclusive
